...
1.  Socio-demographics - Instead of looking at the proportion of water points and technology of water points, we can attempt to understand sociodemographics of the population e.g. affluence, GDP per capita, population size etc. Given that Nigeria is a relatively large country, each region has its separate set of needs and thus consumption behaviour of water points.
